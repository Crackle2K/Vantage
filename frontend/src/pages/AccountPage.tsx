        ...
        <div className="animate-fade-in-up">
          ...
          <div className="glass-card rounded-2xl p-8 mb-6">
            <div className="flex items-start gap-5">
              {/* Avatar */}
              <div className="w-20 h-20 rounded-2xl gradient-primary flex items-center justify-center text-3xl font-bold text-white shadow-lg shadow-brand/20 flex-shrink-0">
            ...
            <div className="glass-card rounded-2xl p-6 mb-6 animate-fade-in">
              ...
              <div className="space-y-4">
                ...
                <div className="flex gap-2 justify-end pt-2">
                  ...
                  <button className="px-5 py-2.5 rounded-xl text-sm font-medium gradient-primary text-white flex items-center gap-2 shadow-lg shadow-brand/20">
